    ...
    <div className={styles.hero}>
      ...
      <div className={styles.hero_text}>
        <h1 className={styles.hero_title}>
          Designer<span className="cy">,</span> Frontend Developer
        </h1>
        <h2 className={styles.hero_desc}>
          Transforming Ideas into Seamless Realities : One Pixel at a Time.
        </h2>
        ...
        <div
          className={`${styles.med} ${styles.float_bot_left} ${styles.react}`}
        >
        ...
        <div
          className={`${styles.med} ${styles.float_bot_right} ${styles.mongo}`}
        >
